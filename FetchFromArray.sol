...
contract FetchFromArray is ChainlinkClient, ConfirmedOwner {
    ...
    constructor() ConfirmedOwner(msg.sender) {
        setChainlinkToken(0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06); // 0x326C977E6efc84E512bB9C30f76E30c160eD06FB
        setChainlinkOracle(0xCC79157eb46F5624204f47AB42b3906cAA40eaB7); // 0xCC79157eb46F5624204f47AB42b3906cAA40eaB7
        jobId = '7d80a6386ef543a3abb52817f6707e3b';
     ...
     */
    function requestFirstId(string memory _ipfs) public returns (bytes32 requestId) {
        Chainlink.Request memory req = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);

        // Set the URL to perform the GET request on
        // API docs: https://www.coingecko.com/en/api/documentation?
        req.add('get', _ipfs); //'https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&per_page=10');
